...
/**
 * Generic helper class for XMLBeans-configured class hierarchies
 */
public class XMLConfig {
    private XMLConfigListener listener;

    public XMLConfig(XMLConfigListener listener) {
	this.listener = listener;
    }

    /**
     * Loads an XMLbeans config file.  For each object found in the file, it
     * will call the loadObject method on the config listener.
     */
    public void load(String relativeName) {
	try {
    ...
    private void load(BufferedInputStream in) throws IOException {
